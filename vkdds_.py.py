...
# Email settings
# IMPORTANT: Never store real passwords/app passwords in source code.
# Email alerts are disabled by default. Enter credentials only at runtime
# through the Email Alerts tab, or use environment variables.
EMAIL_ENABLED = False
EMAIL_SMTP = os.getenv("VKDDS_EMAIL_SMTP", "smtp.gmail.com")
EMAIL_PORT = int(os.getenv("VKDDS_EMAIL_PORT", "587"))
EMAIL_USER = os.getenv("VKDDS_EMAIL_USER", "")
EMAIL_APP_PASSWORD = os.getenv("VKDDS_EMAIL_APP_PASSWORD", "")
EMAIL_TO = os.getenv("VKDDS_EMAIL_TO", "")
...
# --- Fixed white backgrounds ---
    ...
    # --- Load image safely ---
        image_path = str(Path(__file__).resolve().parent / "vkdds_logo.jpg")
...
<div style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <!-- Optional project logo can be added here when the report is hosted with its assets. -->
</div>
...
"""
    ...
    def setup_email_tab(self):
        ...
        # Do not expose or hard-code passwords in the source repository.
        # The user can enter an app password at runtime.
        ...
        ttk.Label(frame,
                   text="Security: credentials are entered at runtime and are not stored in this source file.",
